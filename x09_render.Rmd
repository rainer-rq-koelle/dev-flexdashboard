...
asma_df <- readxl::read_excel("ASMA_Additional_Time.xlsx", sheet = "DATA") %>%
  select(-PIVOT_LABEL)  %>%
  #ASMA provided on an aggregated monthly basis
  mutate( DATE = paste(YEAR, "-", MONTH_NUM, sep = "")
         ,DATE = lubridate::parse_date_time(DATE, "Ym")  
         ,DATE = lubridate::date(DATE)
         ,AVG_ADD_ASMA_TIME = TIME_ASMA_ADD_2/FLT_ASMA_UNIMP_2
         )

slot_df <- readxl::read_excel("ATFM_Slot_Adherence.xlsx", sheet = "DATA")
