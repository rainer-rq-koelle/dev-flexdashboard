...
output: 
  flexdashboard::flex_dashboard:
    ...
    vertical_layout: fill # forces filled page (not good for multiple charts) # scroll # 
---
...
```{r}
valueBox("Overview", icon = "fa-question", href="#home", color="success")
```

### Interactive mortgage rate chart

```{r}
valueBox("Mortgage rates", icon = "fa-line-chart",href="#traffic")
```
...
Even more cool stuff to come soon!